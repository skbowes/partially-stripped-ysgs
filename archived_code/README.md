...
THE FILES THAT THESE INSTRUCTIONS APPLY TO ARE (YSG_TEMP_ESTIMATION.PY, TEMP_LUM_RESULTS.IPYNB) AND THEIR ANALOGS (YSG_TEMP_ESTIMATION_EXCLUDEWORST.PY, TEMP_LUM_RESULTS_EXCLUDEWORST.IPYNB). THE FIRST SET OF THESE FILES ESTIMATE TEMPERATURES FOR YSG STARS USING BOSZ MODELS, FINDING THE BEST FIT. IT SAMPLES THE OBSERVED MAGNITUDES 1000 TIMES FROM A NORMAL DISTRIBUTION, AND FOR EACH OF THOSE SAMPLES IT VARIES THE K-BAND BY PLUS/MINUS 1, 2, SIGMA SINCE THE MODELS ARE SCALED TO THE K-BAND. THE RESULTS OF THIS CAN BE VISUALIZED IN TEMP_LUM_RESULTS.IPYNB. THE _EXCLUDE WORST FILES ARE THE SAME, EXCEPT THAT THEY ALSO INCLUDE SNIPPETS THAT DROP THE WORST-FITTING BAND IF THE CHI2 IS IMPROVED BY SOME THRESHOLD WHEN DROPPING. IT THEN RE-DOES THE FIT FOR THAT SAMPLE OF OBSERVED MAGS. SIMILARLY, THE RESULTS OF THIS CAN BE VISUALIZED IN TEMP_LUM_RESULTS.IPYNB. THE INSTRUCTIONS ON HOW THESE FILES RELY ON OTHER FILES IS WRITTEN BELOW.
